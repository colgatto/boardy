    ...
    return function(t) {
        ...
        const a = {
            ...
            translate: function(t, e) {
                ...
                if (e)
                    for (let t = 0; t < e.length; t++) i = i.replace(new RegExp(`\\{\\{${t}}}`, "g"), e[t]);
                return i
            }
        };
        ...
        class g {
                    ...
                    items(t, e, s) {
                        ...
                        if (Array.isArray(t.items))
                            for (let r = 0; r < e.length; r++)
                                if (t.items[r]) console.log("--\x3e"), i.push(...this._validateSchema(t.items[r], e[r], `${s}.${r}`));
                                else {
            ...
            _expandSchemaLink(t, e) {
                const s = t.links[e].href,
                    i = this.jsoneditor.root.getValue(),
        ...
        class f {
            ...
            expandRefs(t, e) {
                ...
                delete s.$ref;
                const r = i.$ref.startsWith("#") ? i.fetchUrl : "",
                    o = this._getRef(r, i);
                if (this.refs[o]) {
            ...
            _loadExternalRefs(t, e, s, i) {
                ...
                Object.keys(r).forEach(t => {
                    ...
                    const s = this._isLocalUrl(t, i) ? i + t : t,
        ...
        class _ {
            ...
            checkDependency(t, e) {
                ...
                const i = this.jsoneditor.getEditor(t),
                    r = i ? i.getValue() : void 0,
            ...
            addLinks() {
                if (!this.no_link_holder && (this.link_holder = this.theme.getLinksHolder(), void 0 !== this.description ? this.description.parentNode.insertBefore(this.link_holder, this.description) : this.container.appendChild(this.link_holder), this.schema.links))
                    for (let t = 0; t < this.schema.links.length; t++) this.addLink(this.getLink(this.schema.links[t]))
            }
            onMove() {}
            getButton(t, e, s) {
            ...
            refreshWatchedFieldValues() {
                ...
                return this.watched && Object.keys(this.watched).forEach(s => {
                    const i = this.jsoneditor.getEditor(this.watched[s]),
                        r = i ? i.getValue() : null;
            ...
            updateHeaderText() {
                if (this.header) {
                    ...
                    if (this.header.children.length) {
                        for (let e = 0; e < this.header.childNodes.length; e++)
            ...
            setInputAttributes(t) {
                if (this.schema.options && this.schema.options.inputAttributes) {
                    const e = this.schema.options.inputAttributes,
                        s = ["name", "type"].concat(t);
        ...
        class y extends _ {
            ...
            build() {
                if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.options.infoText && (this.infoButton = this.theme.getInfoButton(this.options.infoText)), this.format = this.schema.format, !this.format && this.schema.media && this.schema.media.type && (this.format = this.schema.media.type.replace(/(^(application|text)\/(x-)?(script\.)?)|(-source$)/g, "")), !this.format && this.options.default_format && (this.format = this.options.default_format), this.options.format && (this.format = this.options.format), this.format)
                    ...
                    let t = this.schema.minimum || 0,
                        e = this.schema.maximum || Math.max(100, t + 1),
                        s = 1;
                ...
                if ("range" === this.format && (t = this.theme.getRangeControl(this.input, this.theme.getRangeOutput(this.input, this.schema.default || Math.max(this.schema.minimum || 0, 0)))), this.control = this.theme.getFormControl(this.label, t, this.description, this.infoButton), this.container.appendChild(this.control), window.requestAnimationFrame(() => {
                    ...
                    const t = this.expandCallbacks("template", {
            ...
            ajustIMaskOptions(t) {
                return Object.keys(t).forEach(e => {
                    if (t[e] === Object(t[e])) t[e] = this.ajustIMaskOptions(t[e]);
                    else if ("mask" === e)
                        if ("regex:" === t[e].substr(0, 6)) {
        ...
        class w extends _ {
            ...
            register() {
                if (super.register(), this.rows)
                    for (let t = 0; t < this.rows.length; t++) this.rows[t].register()
            }
            unregister() {
                if (super.unregister(), this.rows)
            ...
            setValue(t = [], e) {
                ...
                this.getMax() && t.length > this.getMax() && (t = t.slice(0, this.getMax())), t.forEach((t, s) => {
                    if (this.rows[s]) this.rows[s].setValue(t, e);
                    else if (this.row_cache[s]) this.rows[s] = this.row_cache[s], this.rows[s].setValue(t, e), this.rows[s].container.style.display = "", this.rows[s].tab && (this.rows[s].tab.style.display = ""), this.rows[s].register(), this.jsoneditor.trigger("addRow", this.rows[s]);
                    else {
            ...
            addRow(t, e) {
                ...
                return this.hide_delete_buttons || (this.rows[s].delete_button = this.getButton(this.getItemTitle(), "delete", this.translate("button_delete_row_title", [this.getItemTitle()])), this.rows[s].delete_button.classList.add("delete", "json-editor-btntype-delete"), this.rows[s].delete_button.setAttribute("data-i", s), this.rows[s].delete_button.addEventListener("click", t => {
                    ...
                    const e = 1 * t.currentTarget.getAttribute("data-i"),
                        s = this.getValue().filter((t, s) => s !== e);
                    let i = null;
                    const r = this.rows[e];
            ...
            addControls() {
                ...
                const t = this.row_holder.style.display,
                    e = this.controls.style.display;
        ...
        class v extends _ {
            ...
            preBuild() {
                ...
                const e = this.jsoneditor.expandRefs(this.schema.items || {}),
                    s = e.enum || [],
        ...
        class C extends _ {
            ...
            build() {
                ...
                const t = this.schema.title || this.key,
                    e = this.expandCallbacks("button", c({}, {
                        icon: "",
                        validated: !1,
                        align: "left",
                        action: (t, e) => {
        ...
        class x extends _ {
            ...
            preBuild() {
                ...
                if (this.input_type = "select", this.enum_options = [], this.enum_values = [], this.enum_display = [], this.schema.enum) {
                ...
                } else if ("boolean" === this.schema.type) this.enum_display = this.schema.options && this.schema.options.enum_titles || ["true", "false"], this.enum_options = ["1", ""], this.enum_values = [!0, !1], this.isRequired() || (this.enum_display.unshift(" "), this.enum_options.unshift("undefined"), this.enum_values.unshift(void 0));
                else {
                    ...
                    if (this.enumSource = [], this.enum_display = [], this.enum_options = [], this.enum_values = [], Array.isArray(this.schema.enumSource))
                        ...
                        } : Array.isArray(this.schema.enumSource[t]) ? this.enumSource[t] = this.schema.enumSource[t] : this.enumSource[t] = c({}, this.schema.enumSource[t]);
                    ...
                    }), "function" == typeof e.template ? this.enumSource[t].value = e.template : this.enumSource[t].value = this.jsoneditor.compileTemplate(this.enumSource[t].value, this.template_engine)), this.enumSource[t].title && (e = this.expandCallbacks("template", {
                        template: this.enumSource[t].title
                    }), "function" == typeof e.template ? this.enumSource[t].title = e.template : this.enumSource[t].title = this.jsoneditor.compileTemplate(this.enumSource[t].title, this.template_engine)), this.enumSource[t].filter && this.enumSource[t].value && (e = this.expandCallbacks("template", {
                        template: this.enumSource[t].filter
                    }), "function" == typeof e.template ? this.enumSource[t].filter = e.template : this.enumSource[t].filter = this.jsoneditor.compileTemplate(this.enumSource[t].filter, this.template_engine))
                }
            }
            build() {
            ...
            onWatchedFieldChange() {
                ...
                if (this.enumSource) {
                    t = this.getWatchedFieldValues();
                    for (let r = 0; r < this.enumSource.length; r++)
                        if (Array.isArray(this.enumSource[r])) s = s.concat(this.enumSource[r]), i = i.concat(this.enumSource[r]);
                        else {
                            let o = [];
        ...
        class k extends x {
            ...
            onWatchedFieldChange() {
                if (super.onWatchedFieldChange(), this.choices_instance) {
                    const t = this.enum_options.map((t, e) => ({
                        value: t,
                        label: this.enum_display[e]
                    }));
        ...
        class j extends y {
            build() {
                ...
                for (let e = this.enum_values.length - 1; e > -1; e--) {
                    const s = this.formname + (e + 1),
                        i = this.theme.getFormInputField("radio");
            ...
            setValue(t) {
                for (let e = 0; e < this.radioGroup.length; e++)
        ...
        const L = {
                ...
                base64: class extends _ {
                    ...
                    setFileReaderListener(t) {
                        t.addEventListener("load", t => {
                            if (this.count === this.current_item_index) this.value[this.count][this.key] = t.target.result;
                            else {
                                const e = {};
                    ...
                    build() {
                        if (this.title = this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired()), this.options.infoText && (this.infoButton = this.theme.getInfoButton(this.options.infoText)), this.input = this.theme.getFormInputField("hidden"), this.container.appendChild(this.input), !this.schema.readOnly && !this.schema.readonly) {
                            ...
                            this.uploader = this.theme.getFormInputField("file"), this.schema.options && this.schema.options.multiple && !0 === this.schema.options.multiple && this.parent && "object" === this.parent.schema.type && this.parent.parent && "array" === this.parent.parent.schema.type && this.uploader.setAttribute("multiple", ""), this.uploader.addEventListener("change", t => {
                                if (t.preventDefault(), t.stopPropagation(), t.currentTarget.files && t.currentTarget.files.length)
                                    if (t.currentTarget.files.length > 1 && this.schema.options && this.schema.options.multiple && !0 === this.schema.options.multiple && this.parent && "object" === this.parent.schema.type && this.parent.parent && "array" === this.parent.parent.schema.type) {
                ...
                datetime: class extends y {
                        ...
                        if (super.build(), this.input && window.flatpickr && "object" == typeof this.options.flatpickr) {
                            ...
                            if (!0 === this.options.flatpickr.wrap) {
                                ...
                                const {
                                    ...
                                    nextSibling: i
                                } = this.input, r = this.theme.getInputGroup(this.input, e);
                    ...
                    setValue(t, e, s) {
                        if ("string" === this.schema.type) super.setValue(t, e, s), this.flatpickr && this.flatpickr.setDate(t);
                        else if (t > 0) {
                            const e = new Date(1e3 * t),
                                s = e.getFullYear(),
                                i = this.zeroPad(e.getMonth() + 1),
                                r = this.zeroPad(e.getDate()),
                                o = this.zeroPad(e.getHours()),
                                n = this.zeroPad(e.getMinutes()),
                                a = this.zeroPad(e.getSeconds()),
                                l = [s, i, r].join("-"),
                                h = [o, n, a].join(":");
                            let d = `${l}T${h}`;
                ...
                describedBy: class extends _ {
                    ...
                    unregister() {
                        if (super.unregister(), this.editors)
                            for (let t = 0; t < this.editors.length; t++) this.editors[t] && this.editors[t].unregister()
                    }
                    getNumColumns() {
                    ...
                    enable() {
                        if (this.editors)
                            for (let t = 0; t < this.editors.length; t++) this.editors[t] && this.editors[t].enable();
                        super.enable()
                    }
                    disable() {
                        if (this.editors)
                            for (let t = 0; t < this.editors.length; t++) this.editors[t] && this.editors[t].disable();
                        super.disable()
                    }
                    switchEditor() {
                    ...
                    buildChildEditor(t) {
                        ...
                        const s = c({}, this.schema, this.jsoneditor.refs[t]),
                            i = this.jsoneditor.getEditorClass(s, this.jsoneditor),
                            r = this.jsoneditor.createEditor(i, {
                                jsoneditor: this.jsoneditor,
                                schema: s,
                                container: e,
                                path: this.path,
                ...
                jodit: class extends y {
                    ...
                    afterInputReady() {
                        let t;
                        window.Jodit ? (t = this.expandCallbacks("jodit", c({}, {
                            height: 300
                        }, this.defaults.options.jodit || {}, this.options.jodit || {})), this.jodit_instance = new window.Jodit(this.input, t), (this.schema.readOnly || this.schema.readonly || this.schema.template) && this.jodit_instance.setReadOnly(!0), this.jodit_instance.events.on("change", () => {
                ...
                multiple: class extends _ {
                    ...
                    disable(t) {
                        if (t && (this.always_disabled = !0), this.editors)
                            for (let e = 0; e < this.editors.length; e++) this.editors[e] && this.editors[e].disable(t);
                    ...
                    buildChildEditor(t) {
                        const e = this.types[t],
                            s = this.theme.getChildEditorHolder();
                        let i;
                ...
                object: class extends _ {
                    ...
                    layoutEditors() {
                        ...
                        this.property_order = Object.keys(this.editors), this.property_order = this.property_order.sort((t, e) => {
                            let s = this.editors[t].schema.propertyOrder,
                                i = this.editors[e].schema.propertyOrder;
                            return "number" != typeof s && (s = 1e3), "number" != typeof i && (i = 1e3), s - i
                        });
                        const i = "categories" === this.format,
                            r = [];
                        let o, n = null,
                            a = null;
                        if ("grid-strict" === this.format) {
                            ...
                            if (o = [], this.property_order.forEach(t => {
                                    ...
                                    const s = e.options.hidden ? 0 : e.options.grid_columns || e.getNumColumns(),
                                        ...
                                        a = !e.options.hidden && (e.options.grid_break || !1),
                                        l = {
                                            key: t,
                                            width: s,
                                            offset: n,
                            ...
                            for (this.layout = JSON.stringify(r), s = document.createElement("div"), t = 0; t < r.length; t++)
                                for (o = this.theme.getGridRow(), s.appendChild(o), e = 0; e < r[t].length; e++) n = r[t][e].key, a = this.editors[n], a.options.hidden ? a.container.style.display = "none" : this.theme.setGridColumnSize(a.container, r[t][e].width, r[t][e].offset), o.appendChild(a.container)
                            ...
                            for (this.layout = JSON.stringify(r), s = document.createElement("div"), t = 0; t < r.length; t++)
                                for (o = this.theme.getGridRow(), s.appendChild(o), e = 0; e < r[t].editors.length; e++) n = r[t].editors[e].key, a = this.editors[n], a.options.hidden ? a.container.style.display = "none" : this.theme.setGridColumnSize(a.container, r[t].editors[e].width), o.appendChild(a.container)
                        } else {
                            if (s = document.createElement("div"), i) {
                                const t = document.createElement("div"),
                                    e = this.theme.getTopTabHolder(this.schema.title),
                    ...
                    addRow(t, e, s) {
                        const i = this.rows.length,
                            r = "object" === t.schema.type || "array" === t.schema.type;
                        ...
                        if (this.rows = [], this.active_tab = null, this.options.table_row) this.editor_holder = this.container, Object.entries(this.editors).forEach(([t, e]) => {
                            ...
                            if (this.options.table) throw new Error("Not supported yet"); {
                                ...
                                e.style.clear = "both", this.addproperty_holder.appendChild(e), document.addEventListener("click", this.onOutsideModalClick), this.schema.description && (this.description = this.theme.getDescription(this.schema.description), this.container.appendChild(this.description)), this.error_holder = document.createElement("div"), this.container.appendChild(this.error_holder), this.editor_holder = this.theme.getIndentedPanel(), this.container.appendChild(this.editor_holder), this.row_container = this.theme.getGridContainer(), t ? (this.tabs_holder = this.theme.getTopTabHolder(this.getValidId(this.schema.title)), this.tabPanesContainer = this.theme.getTopTabContentHolder(this.tabs_holder), this.editor_holder.appendChild(this.tabs_holder)) : (this.tabs_holder = this.theme.getTabHolder(this.getValidId(this.schema.title)), this.tabPanesContainer = this.theme.getTabContentHolder(this.tabs_holder), this.editor_holder.appendChild(this.row_container)), Object.values(this.editors).forEach(e => {
                                    const s = this.theme.getTabContent(),
                                        i = this.theme.getGridColumn(),
                    ...
                    addPropertyCheckbox(t) {
                        ...
                        const i = this.theme.getCheckboxLabel(e),
                            r = this.theme.getFormControl(i, s);
                ...
                simplemde: class extends y {
                    ...
                    afterInputReady() {
                        let t;
                        window.SimpleMDE ? (t = this.expandCallbacks("simplemde", c({}, {
                            height: 300
                        }, this.defaults.options.simplemde || {}, this.options.simplemde || {}, {
                            element: this.input
                        })), this.simplemde_instance = new window.SimpleMDE(t), (this.schema.readOnly || this.schema.readonly || this.schema.template) && (this.simplemde_instance.codemirror.options.readOnly = !0), this.simplemde_instance.codemirror.on("change", () => {
                ...
                table: class extends w {
                    ...
                    build() {
                        ...
                        if (this.item_default = t.getDefault(), this.width = t.getNumColumns() + 2, this.options.compact ? (this.panel = document.createElement("div"), this.container.appendChild(this.panel)) : (this.header = document.createElement("label"), this.header.textContent = this.getTitle(), this.title = this.theme.getHeader(this.header), this.container.appendChild(this.title), this.title_controls = this.theme.getHeaderButtonHolder(), this.title.appendChild(this.title_controls), this.schema.description && (this.description = this.theme.getDescription(this.schema.description), this.container.appendChild(this.description)), this.panel = this.theme.getIndentedPanel(), this.container.appendChild(this.panel), this.error_holder = document.createElement("div"), this.panel.appendChild(this.error_holder)), this.panel.appendChild(this.table), this.controls = this.theme.getButtonHolder(), this.panel.appendChild(this.controls), this.item_has_child_editors) {
                            const e = t.getChildEditors(),
                                s = t.property_order || Object.keys(e);
                ...
                upload: class extends _ {
                    ...
                    build() {
                        if (this.options.compact || (this.header = this.label = this.theme.getFormInputLabel(this.getTitle(), this.isRequired())), this.schema.description && (this.description = this.theme.getFormInputDescription(this.schema.description)), this.options.infoText && (this.infoButton = this.theme.getInfoButton(this.options.infoText)), this.options = this.expandCallbacks("upload", c({}, {
                            ...
                            this.uploadHandler = t => {
                                ...
                                if (e && e.length)
                                    if (0 !== this.options.max_upload_size && e[0].size > this.options.max_upload_size) this.theme.addInputError(this.uploader, "Filesize too large. Max size is " + this.options.max_upload_size);
                                    else if (0 === this.options.mime_type.length || this.isValidMimeType(e[0].type, this.options.mime_type)) {
                        ...
                        const t = this.uploader || this.input,
                    ...
                    refreshPreview(t) {
                        ...
                        const e = t[0],
                            s = this.preview_value.match(/^data:([^;,]+)[;,]/);
            ...
            T = {
                ...
                lodash: () => !!window._ && {
                    compile: t => e => window._.template(t)(e)
                },
                markup: () => !(!window.Mark || !window.Mark.up) && {
                    compile: t => e => window.Mark.up(t, e)
                },
                mustache: () => !!window.Mustache && {
                    compile: t => e => window.Mustache.render(t, e)
                },
                swig: () => window.swig,
                underscore: () => !!window._ && {
                    compile: t => e => window._.template(t)(e)
        ...
        class G extends P {
            ...
            getFormControl(t, e, s, i) {
                const r = document.createElement("div");
                if (r.classList.add("form-group"), !t || "checkbox" !== e.type && "radio" !== e.type) t && (r.appendChild(t), i && r.appendChild(i)), r.appendChild(e);
                else {
                    const s = document.createElement("div");
        ...
        class K {
            constructor(t, e = {}) {
                ...
                const s = this.options.theme || K.defaults.theme,
                    i = K.defaults.themes[s];
                ...
                const n = document.location.origin + document.location.pathname.toString(),
                    a = new f(this.options),
                ...
                this.expandSchema = (t, e) => a.expandSchema(t, e), this.expandRefs = (t, e) => a.expandRefs(t, e), this.refs = a.refs, a.load(this.schema, t => {
                    const e = this.options.custom_validators ? {
            ...
            trigger(t, e) {
                if (this.callbacks && this.callbacks[t] && this.callbacks[t].length)
                    for (let s = 0; s < this.callbacks[t].length; s++) this.callbacks[t][s].apply(this, [e]);
                return this
            }
            setOption(t, e) {
            ...
            addNewStyleRules(t, e) {
                ...
                const i = s.sheet ? s.sheet : s.styleSheet,
                    r = this.element.nodeName.toLowerCase();
                Object.keys(e).forEach(s => {
